...
if __name__ == '__main__':
    ...
    for filename in os.listdir(args['img_path']):
        ...
        if filename.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp', '.tiff', '.gif')):
            # Process the image and get the debug image
            print(file_path)
            ...
            cv2.imwrite('D:\\pythonProject\\2024\\PytorchOCR-master\\PytorchOCR-master\\picture_source_reslut2\\{}.jpg'.format(filename), debug_img)
