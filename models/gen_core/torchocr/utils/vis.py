...
def draw_ocr_box_txt_for_video(image, boxes, txts = None, pos="horizontal"):
    ...
    for i,box in enumerate(boxes):
        ...
        if txts is not None: # and str(txts[i]).isdigit():
            # print(txts[i])
            txt = str(txts[i])
            font_size = 15
            ...
            char_size = font.getsize(txt)
            # if i == 7:
            #     draw_left.text((20, cur_y), str(i+1)+'.'+'2.35', fill=(0, 0, 0), font=font)
            # elif i == 11:
            #     draw_left.text((20, cur_y), str(i+1)+'.'+'21.85', fill=(0, 0, 0), font=font)
            # else:
            draw_left.text((15, cur_y), str(i+1)+'.'+txt, fill=(0, 0, 0), font=font)
            cur_y += 15
            draw_left.polygon(box, outline=(0, 255, 0)) # , width=10
            # else:
